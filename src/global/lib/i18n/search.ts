...
const SEARCH_DICTIONARY: Record<LocaleCode, Record<SearchKey, string>> = {
  ...
  fr: {
    ...
    back: 'Retour',
    search_services_placeholder: 'Rechercher un service, une societe ou une specialite...',
    location_placeholder: 'Ville ou quartier',
    search: 'Rechercher',
    searching_short: 'Recherche en cours...',
    searching_services: 'Recherche des meilleures correspondances...',
    ...
    no_results_description: 'Essayez d\'autres mots-cles, une zone proche ou moins de filtres.',
  ...
  ar: {
    ...
    no_results_description: 'جرّب كلمات مختلفة، منطقة قريبة، او قلل عدد الفلاتر.',
