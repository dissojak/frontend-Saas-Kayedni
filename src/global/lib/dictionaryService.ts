...
const DEFAULT_DICTIONARY: Record<LocaleCode, Record<DictionaryKey, string>> = {
  ...
  fr: {
    ...
    footer_subscribe_desc: 'Recevez les nouveautes produit, les conseils de croissance et les offres du moment.',
  ...
  ar: {
    ...
    footer_subscribe_desc: 'اشترك ليصلك جديد المنصة، نصائح النمو، وافضل العروض.',
