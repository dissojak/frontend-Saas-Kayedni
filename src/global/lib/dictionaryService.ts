...
const DEFAULT_DICTIONARY: Record<LocaleCode, Record<DictionaryKey, string>> = {
  ...
  fr: {
    nav_home: 'Accueil',
    nav_find_services: 'Trouver des services',
    ...
    nav_my_workspace: 'Mon espace',
    nav_my_schedule: 'Mon planning',
    ...
    nav_enable_staff_telegram: 'Activer Telegram personnel',
    ...
    locale_arabic: 'Arabe',
    footer_brand_tagline:
      'Nous simplifions les reservations pour tous. La plateforme tout-en-un pour les entreprises et les clients modernes.',
    footer_product: 'Produit',
    footer_company: 'Entreprise',
    footer_stay_updated: 'Restez informes',
    footer_subscribe_desc: 'Abonnez-vous a notre newsletter pour recevoir les dernieres mises a jour et offres.',
    footer_features: 'Fonctionnalites',
    footer_pricing: 'Tarifs',
    footer_find_services: 'Trouver des services',
    footer_integrations: 'Integrations',
  ...
  ar: {
    nav_home: 'الرئيسية',
    nav_find_services: 'ابحث عن الخدمات',
    nav_my_bookings: 'حجوزاتي',
    nav_dashboard: 'لوحة التحكم',
    nav_my_business: 'عملي',
    nav_staff: 'الموظفون',
    nav_services: 'الخدمات',
    nav_bookings: 'الحجوزات',
    nav_my_workspace: 'مساحة العمل',
    nav_my_schedule: 'جدولي',
    nav_businesses: 'الاعمال',
    ...
    footer_brand_tagline: 'نبسط الحجوزات للجميع. منصة متكاملة للشركات والعملاء العصريين.',
    footer_product: 'المنتج',
    footer_company: 'الشركة',
    footer_stay_updated: 'ابق على اطلاع',
    footer_subscribe_desc: 'اشترك في النشرة البريدية للحصول على اخر التحديثات والعروض.',
    footer_features: 'الميزات',
    footer_pricing: 'الاسعار',
    footer_find_services: 'ابحث عن الخدمات',
