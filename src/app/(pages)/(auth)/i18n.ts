...
const MESSAGES: Record<LocaleCode, Record<AuthKey, string>> = {
    en: {
        ...
        register_business_email_optional: "Business email (optional)",
        register_business_email_placeholder: "business@example.com",
        register_description_optional: "Description (optional)",
    ...
    fr: {
        ...
        auth_trusted_title: "Adopte par les equipes professionelles",
        ...
        register_hero_desc: "Les particuliers s'inscrivent en une etape. Les proprietaires suivent 3 etapes simples avec une etape supplementaire seulement si necessaire.",
        register_step_owner: "Proprietaire",
        register_step_business: "Entreprise",
        ...
        register_owner_details_complete: "Le compte proprietaire et les details de l'entreprise sont complets.",
        ...
        register_business_name_placeholder: "Downtown Barber Studio",
        register_business_location: "Adresse de l'entreprise",
        register_business_location_placeholder: "Le Caire, Nasr City",
        register_business_category: "Categorie d'entreprise",
        ...
        register_category_not_found: "Categorie introuvable. Vous enverrez une demande d'industrie a l'etape 4.",
        register_phone_optional: "Telephone (optionnel)",
        register_phone_placeholder: "+216 00 000 000",
        register_business_email_optional: "E-mail professionnel (optionnel)",
        register_business_email_placeholder: "entreprise@exemple.com",
        ...
        register_describe_industry_placeholder: "Expliquez votre activite pour que nous priorisions ce secteur",
        register_phone_required_followup: "Telephone (obligatoire pour le suivi)",
        register_back: "Retour",
        register_continue_business_details: "Continuer vers les details entreprise",
        register_continue_optional_details: "Continuer vers les details a completer",
        register_continue_industry_request: "Continuer vers la demande secteur",
        register_creating_account: "Creation du compte...",
        register_create_owner_business: "Creer proprietaire + entreprise",
        register_smooth_onboarding: "Onboarding fluide pour clients et entreprises.",
        ...
        error_register_business_name_required: "Veuillez saisir le nom de l'entreprise",
        error_register_business_location_required: "Veuillez saisir l'adresse de l'entreprise",
    ...
    ar: {
        ...
        login_welcome_title: "مرحبا بك في kayedni",
        ...
        register_join_kayedni: "انضم الى kayedni",
        ...
        register_business_name_placeholder: "Downtown Barber Studio",
        register_business_location: "موقع الشركة",
        register_business_location_placeholder: "نابل، المعمورة، شارع الحبيب بورقيبة",
        register_business_category: "نوع النشاط",
        register_select_category: "اختر نوع النشاط",
        ...
        register_category_not_found: "فئة النشاط غير موجودة. ستقدم طلب فئة في الخطوة 4.",
        register_phone_optional: "رقم الهاتف ",
        register_phone_placeholder: "000 000 00 +216",
        register_business_email_optional: "بريد النشاط (اختياري)",
        register_business_email_placeholder: "business@example.com",
        register_description_optional: "وصف النشاط (الشركة)",
        register_description_placeholder: "صف خدماتك وما تقدمه",
        register_actual_industry_name: "الاسم الفعلي لنوع نشاطك",
        register_actual_industry_placeholder: "مثال: حلاقة، مقهى، عيادة طبية",
        register_describe_industry: "صف نشاطك",
        register_describe_industry_placeholder: "اخبرنا بما تقدمه حتى نعطي هذا النشاط اولوية",
        ...
        register_continue_industry_request: "المتابعة لطلب النشاط",
        register_creating_account: "جار انشاء الحساب...",
        register_create_owner_business: "إنشاء حساب المدير والشركة",
        register_smooth_onboarding: "تهيئة سلسة للعملاء و المديرين.",
        ...
        error_register_business_name_required: "يرجى ادخال اسم النشاط",
        error_register_business_location_required: "يرجى ادخال موقع النشاط",
        error_register_business_category_required: "يرجى اختيار فئة النشاط",
        error_register_phone_length: "يجب ان يكون رقم الهاتف بين 8 و20 حرفا",
        error_register_industry_name_required: "يرجى ادخال الاسم الفعلي للنشاط",
        error_register_industry_description_required: "يرجى وصف نشاطك حتى نراجعه",
        error_register_phone_required_other: "رقم الهاتف مطلوب لطلبات الانشطة الاخرى",
