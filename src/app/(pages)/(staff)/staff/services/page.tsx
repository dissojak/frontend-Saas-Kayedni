          ...
          <Card className="border-yellow-200 bg-yellow-50 dark:bg-yellow-900/20 dark:border-yellow-800">
            <CardContent className="py-8 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">
                {staffServicesT(locale, "no_business_linked_title")}
              </h3>
      ...
      <Card className="border-dashed">
        <CardContent className="py-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
            {searchTerm
              ? staffServicesT(locale, "no_services_found")
              : staffServicesT(locale, "no_services_yet")}
          </h3>
                ...
                >
                  {service.active ? (
                    <>
                      ...
                      {staffServicesT(locale, "status_active")}
                    </>
                  ) : (
                    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
              ...
              <>
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    {businessName
                      ? staffServicesT(locale, "services_offered_by_business", {
                          business: businessName,
                        })
                      : staffServicesT(locale, "services_offered_by_your_business")}
                  </p>
                </div>
                <Button variant="ghost" size="icon" onClick={() => router.push("/staff/dashboard")}>
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => router.push("/staff/services/my-services")}>
